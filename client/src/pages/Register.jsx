...
import { Briefcase, Mail, Lock, User, Loader2, Zap } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-[#05070a] relative overflow-hidden px-4 py-12 transition-colors duration-700">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-slate-500 dark:text-slate-400 font-medium">Join the intelligent recruitment revolution.</p>
        </div>
        ...
        <div className="neuro-card p-10 rounded-[40px] border border-slate-200 dark:border-white/5 shadow-2xl">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                <label className="text-xs font-black text-slate-500 uppercase tracking-[0.2em] ml-1">Secure Password</label>
                <div className="relative group">
                  <span className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-sky-500 transition-colors">
            ...
            >
              {loading ? <Loader2 className="h-5 w-5 animate-spin" /> : 'Create Commander Account'}
            </button>
